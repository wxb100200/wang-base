...
public class DigestUtils {
	...
	public static void main(String[] args) {
		String input1="asdfsadfsdaf2335士大夫士大夫大师傅撒旦飞洒地方撒旦发";
		String input2="asdfsadfsdaf2335士大夫士大夫大师asdfsdafsdafasfasfdsadfsadfsadfsaddfsaddfsadfsadfsdf撒旦发";
		String sha1=DigestUtils.sha1ToHex(input1);
		String sha2=DigestUtils.sha1ToHex(input2);
		System.out.println("--->>>sha1:"+sha1);
		System.out.println("--->>>sha2:"+sha2);
		String md51=DigestUtils.md5ToHex(input1);
		String md52=DigestUtils.md5ToHex(input2);
